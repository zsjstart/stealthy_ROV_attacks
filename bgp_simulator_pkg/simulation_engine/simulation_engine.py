...
from caida_collector_pkg.graph import BGPDAG, AS
...
class SimulationEngine(BGPDAG):
    ...
    def _propagate_to_providers(self,
        ...
        # Propagation_ranks in caida_collector_pkg.bgp_dag.propogation_rank_funcs.py
        for i, rank in enumerate(self.propagation_ranks):
            ...
            if i > 0:
                ...
                for as_obj in rank:
                    ...
                    as_obj.process_incoming_anns(# process_incoming_anns in as_classes.bgp.bgp_simple_as.process_incoming_funcs.py
